...
- Ukuran dunia: **18656 x 16944 studs**, grid **2 x 2** = 4 tile.
- Size Y (relief): **3328 studs**.
- flip_z: **False**.

> **Catatan tiling:**
> - voxel_align: Size disnap ke kelipatan 8 studs; dunia 18661.7x16945.4 -> 18656x16944, Size_Y 3328 -> 3328 (geser <0.03%).
> - Tinggi DEM 137px tidak habis dibagi 2 tile; sisa 1px diserap ke tile Z terakhir.
...
- Piksel sumber: 82 x 69 px
- **Size**:  X = `9328`,  Y = `3328`,  Z = `8472`  (studs)
- **Position**:  X = `-4664`,  Y = `-1664`,  Z = `-4236`  (studs)
- Material: `Sandstone`

### RUH_tile_x1_z0.png  (ix=1, iz=0)

- Piksel sumber: 81 x 69 px
- **Size**:  X = `9328`,  Y = `3328`,  Z = `8472`  (studs)
- **Position**:  X = `4664`,  Y = `-1664`,  Z = `-4236`  (studs)
- Material: `Sandstone`
