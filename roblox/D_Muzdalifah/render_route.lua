--[[ render_route.lua — Command Bar Studio
  Gambar JALAN manasik (final, aspal) dari ModuleScript "MuzdalifahRoute".
  ...
  Prasyarat: ModuleScript "MuzdalifahRoute" di ReplicatedStorage; terrain Muzdalifah sudah ada.
  Jalankan SETELAH build_muzdalifah.lua (biar terrain & area sudah final).
]]
...
local m = RS:FindFirstChild("MuzdalifahRoute")
if not m then warn("[Route] ModuleScript 'MuzdalifahRoute' tak ada."); return end
...
local folder = workspace:FindFirstChild("Muzdalifah_Route")
if folder then folder:Destroy() end
folder = Instance.new("Folder"); folder.Name = "Muzdalifah_Route"; folder.Parent = workspace
