--[[ render_route.lua — Command Bar Studio
  Gambar JALAN manasik (final, aspal) dari ModuleScript "MinaRoute".
  ...
  Prasyarat: ModuleScript "MinaRoute" di ReplicatedStorage; terrain Mina sudah ada.
...
local m = RS:FindFirstChild("MinaRoute")
if not m then warn("[Route] ModuleScript 'MinaRoute' tak ada."); return end
...
local folder = workspace:FindFirstChild("Mina_Route")
if folder then folder:Destroy() end
folder = Instance.new("Folder"); folder.Name = "Mina_Route"; folder.Parent = workspace
