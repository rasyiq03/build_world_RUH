--[[ render_route.lua — Command Bar Studio
  Gambar JALAN manasik (final, aspal) dari ModuleScript "ArafahRoute".
...
local folder = workspace:FindFirstChild("Arafah_Route")
if folder then folder:Destroy() end
folder = Instance.new("Folder"); folder.Name = "Arafah_Route"; folder.Parent = workspace
